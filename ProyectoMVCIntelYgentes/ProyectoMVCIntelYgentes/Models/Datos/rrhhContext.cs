...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=CARLOS\\SQLEXPRESS;Initial Catalog=rrhh;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Departamento>(entity =>
            {
                entity.HasKey(e => e.DeptoNo)
                    .HasName("PK__departam__7A16B961C5DDF1D0");
            ...
            modelBuilder.Entity<Empleado>(entity =>
            {
                entity.HasKey(e => e.EmpNo)
                    .HasName("PK__empleado__129850FAB31C12A5");
